    ...
    return (
        <div className="dashboard-header">
            ...
            <div className="d-flex align-items-center">
                ...
                <button className="profile-circle dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false" type="button">
                    B
                </button>
                <ul className="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="profileDropdown">
                    ...
                    <li><button className="dropdown-item" type="button">About</button></li>
